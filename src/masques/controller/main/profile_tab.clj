...
(defn load-data [main-frame]
  (profile-tab-view/set-data main-frame
                             (name-model/first-current-identity-name) 
                             (email-model/first-current-identity-email-address)
                             (phone-number-model/first-current-identity-phone-number)
                             (address-model/first-current-identity-address)))
