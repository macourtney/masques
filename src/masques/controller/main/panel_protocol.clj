...
(defprotocol PanelProtocol
  ...
  (create-view [this]
               "Creates the view to be placed in the display area of the main
window.")

  (icon [this] "Returns the icon for this panel.")
  
  (display-text [this] 
                "Returns the text representation of this panel. Used in the tool
bar.")

  (init [this view show-panel-fn]
        "Called when the panel is added. The show-panel-fn is a function for
showing panels. The function takes only the panel you want to show and
arguments.")
...
PanelProtocol, then this function simply returns panel."
  [panel]
